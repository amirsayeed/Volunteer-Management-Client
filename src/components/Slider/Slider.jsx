    ...
    return (
        <div className="max-w-7xl mx-auto px-1 md:px-0">
            ...
            <div id="slide1" className="carousel-item relative w-full px-1">
                ...
                <div className='max-w-lg space-y-5 absolute top-10 md:top-1/3 left-12 md:left-20'>
                    <motion.h2 
                    initial={{ scale: 0 }} 
                    animate={{ 
                        scale: 1,
                    ...
                    className="font-bold text-2xl md:text-5xl"><motion.span
                    animate={{
            ...
            <div id="slide2" className="carousel-item relative w-full">
                ...
                <div className='max-w-lg space-y-5 absolute top-10 md:top-1/3 left-12 md:left-20'>
                    ...
                    className="font-semibold text-2xl md:text-5xl"><motion.span
                     animate={{
                        color: ['#f05146', '#72ee5b', '#41f1e4'],
                        transition: { duration: 3, repeat: Infinity }
                     }}
            ...
            <div id="slide3" className="carousel-item relative w-full">
                ...
                <div className='max-w-lg space-y-5 absolute top-10 md:top-1/3 left-12 md:left-20'>
                    ...
                    className="font-semibold text-2xl md:text-5xl"><motion.span animate={{
                    color: ['#f05146', '#72ee5b', '#41f1e4'],
                    transition: { duration: 3, repeat: Infinity }
                    }}
